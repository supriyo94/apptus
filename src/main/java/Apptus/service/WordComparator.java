...
public class WordComparator {
    public ResponseDTO WordDifferences(List<XWPFParagraph> page1_paragraphsList,
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                ...
                String paragraph1_String = paragraph1.getText();
                String paragraph2_String = paragraph2.getText();

                XWPFParagraph diffParagraph = diffDoc.createParagraph();

                // Compare the words of the paragraphs
                List<String> words_1 = splitIntoWords(paragraph1_String);
                ArrayList<String> array1List = new ArrayList<>(words_1);
                List<String> words_2 = splitIntoWords(paragraph2_String);
